...
Choicekit is **not** a renderer, UI framework, or Twine runtime. It does not parse Twine markup or ship a UI. Your app decides how passages are represented (string, Markdown, components, etc.) and how they get displayed.
