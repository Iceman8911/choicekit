...
Inspired by [Twine SugarCube](https://www.motoslave.net/sugarcube/2/), Choicekit is a lightweight[^1], headless, framework-agnostic library for building web-based interactive fiction.
...
This library is uploaded to npm at https://www.npmjs.com/package/Choicekit
...
<Tabs syncKey="packageManager">
  ...
  <TabItem label="pnpm">
    <Code code="pnpm install Choicekit" lang="bash"   />
  </TabItem>
  <TabItem label="yarn">
    <Code code="yarn install Choicekit" lang="bash"  />
  </TabItem>
  <TabItem label="bun">
    <Code code="bun install Choicekit" lang="bash"  />
  </TabItem>
</Tabs>
